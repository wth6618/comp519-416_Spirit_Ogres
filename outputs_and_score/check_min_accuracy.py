...
#      
  ...
  with open( g.args.test, 'r' ) as iFH:
    for line in iFH:
      ...
      if FAIL and reported_failures < fails_to_report:
...
#python3 check_min_accuracy.py -e 3 ~/Challenge_9934185_A.chromosomes/A.transcripts.fasta ~/Challenge_9934185_B.chromosomes/B.transcripts.fasta ~/Challenge_9934185_A.chromosomes/A.gff3 ~/Challenge_9934185_B.chromosomes/B.gff3 ~/Challenge_9934185_scoring/dev_validation_set.tsv ~/Challenge_9934185_scoring/test_validation_set.tsv
